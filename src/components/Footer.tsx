  ...
  let social_media = [
    {
      ...
      alt: "mail logo",
      img_src: "/icons/email-logo-round.svg",
    },
    {
      name: "Telegram",
      href: "https://t.me/CLICGameStar",
      alt: "telegram logo",
      img_src: "/icons/telegram-logo-round.svg",
    },
    {
      name: "Instagram",
      href: "https://instagram.com/CLICGameStar",
      alt: "instagram logo",
      img_src: "/icons/instagram-logo-round.svg",
    },
    {
      name: "Discord",
      href: "https://discord.gg/tMaKxY8V4M",
      alt: "discord-logo",
      img_src: "/icons/discord-logo-round.svg",
    },
  ];
  return (
    <footer>
      <div className="container footer-container">
        <InscriptionFooter
          curr_year={year}
          inscription_form_link={inscription_link}
        />
