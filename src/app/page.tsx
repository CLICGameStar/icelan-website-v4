    ...
    <main>
      ...
      <section className="container about">
        ...
        <p className="description">
          ...
          <span className="highlight-green"> animations </span> sur tout le site, et
          des
          <span className="highlight-green"> repas chauds, snacks et boissons </span>
        ...
        <a className="button button-green" href="/infos" target="_blank">Plus d'infos</a>
      </section>
      <section className="conatiner chiffres">
        <div className="block-compteur">
          <div className="compteur" id="participant-counter">{nombre_participants}</div>
          <div className="titre-compteur">Participant·e·s</div>
        </div>
        <div className="block-compteur">
          <div className="compteur" id="staff-counter">{nombre_staff}</div>
          <div className="titre-compteur">Staffs</div>
        </div>
        <div className="block-compteur">
          <div className="compteur" id="tournament-counter">{nombre_tournois}</div>
          <div className="titre-compteur">Tournois</div>
        </div>
        <div className="block-compteur">
          <div className="compteur" id="animation-counter">{nombre_animations}</div>
