      ...
      <main>
        ...
        <section className="container about">
          ...
          <p className="description">
            ICeLAN est un week-end de tournois de jeux vidéo et de jeux de
            plateau à l'EPFL. L’événement s’axe principalement autour des
            tournois, se succédant tout au long du week-end, mais offre
            également aux participant·e·s des animations autour du jeu vidéo et
            du jeu tout court pour les divertir durant tout l’événement !
            L’inscription à l’événement offre aux participant·e·s l’accès à tous
            les
