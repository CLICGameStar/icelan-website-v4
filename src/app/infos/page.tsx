/*
          ...
          <br />
          <br />
          Le planning des tournois n'a pas encore été décidé.
          Si jamais vous voulez proposer des jeux pour la prochaine
          édition, vous pouvez rejoindre le lien
          <a href="https://discord.gg/tMaKxY8V4M">du discord</a> et
        ...
        <div class="timeline">
          ...
          <div class="timeline-hours">
            <div class="tl-hour tl-saturday">09h</div>
            <div class="tl-hour tl-saturday">10h</div>
            <div class="tl-hour tl-saturday">11h</div>
            <div class="tl-hour tl-saturday">12h</div>
            <div class="tl-hour tl-saturday">13h</div>
            <div class="tl-hour tl-saturday">14h</div>
            <div class="tl-hour tl-saturday">15h</div>
            <div class="tl-hour tl-saturday">16h</div>
          ...
          <div class="timeline-games">
            <div class="tl-game tl-game-pink tl-accueil" area="accueil">
              Accueil
            </div>

            <div class="tl-game tl-game-green tl-minecraft-hg">
              Minecraft Hunger Games
            </div>
            <div class="tl-game tl-game-blue tl-echecs">Echecs</div>

            <div class="tl-game tl-game-break tl-repas">Repas</div>

            <div class="tl-game tl-game-blue tl-geoguessr">Geoguessr</div>
            <div class="tl-game tl-game-pink tl-overcooked">Overcooked 2</div>

            <div class="tl-game tl-game-pink tl-mariokart">Mario Kart 8DX</div>
            <div class="tl-game tl-game-green tl-pingpong">Ping-pong</div>
            <div class="tl-game tl-game-blue tl-triviapoly">TriviaPoly</div>

            <div class="tl-game tl-game-green tl-balatro">Balatro</div>
            <div class="tl-game tl-game-blue tl-lg-une-nuit">
              Loup-garou une Nuit
            </div>

            <div class="tl-game tl-game-break tl-repas2">Repas</div>

            <div class="tl-game tl-game-pink tl-babyfoot">Babyfoot</div>
            <div class="tl-game tl-game-green tl-valorant">Valorant</div>

            <div class="tl-game tl-game-pink tl-smashbros">
              Super Smash Bros Ultimate 1v1
            </div>
            <div class="tl-game tl-game-blue tl-osu">OSU</div>

            <div class="tl-game tl-game-blue tl-amongus">Among Us</div>
            <div class="tl-game tl-game-green tl-overwatch">Overwatch 2</div>
            <div class="tl-game tl-game-blue tl-rocket-league">
              Rocket League 3v3
            </div>

            <div class="tl-game tl-game-pink tl-starcraft">Starcraft 2</div>
            <div class="tl-game tl-game-blue tl-lol">League of Legends</div>
            <div class="tl-game tl-game-pink tl-smashbros2">
              Super Smash Bros Ultimate 2v2
            </div>

            <div class="tl-game tl-game-green tl-hollow-knight">
              Hollow Knight (Speedrun)
            </div>
            <div class="tl-game tl-game-blue tl-minecraft">
              Minecraft (Speedrun)
            </div>
            <div class="tl-game tl-game-pink tl-risk-rain">
              Risk of Rain 2 (Speedrun)
            </div>

            <div class="tl-game tl-game-break tl-repas3">Repas</div>

            <div class="tl-game tl-game-blue tl-jeumystere">Jeu Mystère</div>
            <div class="tl-game tl-game-green tl-remiseprix">
              Remise des prix
            </div>
        ...
        <img class="timeline2" src="assets/img/timeline-mobile.svg" />
      </section>
-->
          ...
          <div class="info-bloc">
            ...
            <p class="description">
              Sur place, il te sera possible de profiter de douches et de
              toilettes. Il n'est pas possible de dormir dans le bâtiment, mais
              nous avons réservé les abris PC du campus, où vous pouvez aller
              dormir entre minuit et 8h du matin. Pensez à apporter un sac de
              couchage, parce qu'il y fait assez froid et qu'il n'y a pas de
              draps.
            </p>
          </div>
